                ...
                <div className="flex flex-col gap-5 border border-gray-200 rounded-xl p-4">
                    ...
                    <RenderIf condition={!isFetching}>
                        <RenderIf condition={candidates?.length! > 0}>
                            <motion.div initial={routeVariants.initial} animate={routeVariants.final} exit={routeVariants.initial} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                                {
                                    candidates?.map((item) =>
